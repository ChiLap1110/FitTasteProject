...
class Swift_Mime_SimpleMessage extends Swift_Mime_MimePart
{
    ...
    {
        if (!$this->setHeaderFieldModel('Disposition-Registration-To', $addresses)) {
            $this->getHeaders()
                ->addMailboxHeader('Disposition-Registration-To', $addresses);
        }
    ...
    {
        return $this->getHeaderFieldModel('Disposition-Registration-To');
    }
