...
class Swift_Mime_SimpleMessageTest extends Swift_Mime_MimePartTest
{
    ...
    {
        $rcpt = $this->createHeader('Disposition-Registration-To',
            array('chris@swiftmailer.org' => 'Chris')
            );
        $message = $this->createMessage(
            $this->createHeaderSet(array('Disposition-Registration-To' => $rcpt)),
            $this->createEncoder(), $this->createCache()
            );
    ...
    {
        $rcpt = $this->createHeader('Disposition-Registration-To', array(), array(), false);
    ...
    public function testReadReceiptHeaderIsAddedIfNoneSet()
    {
        ...
        $headers->shouldReceive('addMailboxHeader')
                ->once()
                ->with('Disposition-Registration-To', 'mark@swiftmailer.org');
        $headers->shouldReceive('addMailboxHeader')
                ->zeroOrMoreTimes();
